...
mod tests {
    ...
    const EXPECTED_TOOLS: &[&str] = &[
        ...
        "cancel_approval", "cancel_attendance_application", "cancel_reservation",
        "create_calendar_event", "create_mailbox", "delete_approval_line",
        "delete_calendar_event", "delete_mail", "delete_mail_rule", "delete_mailbox",
        "delete_person_group", "delete_temp_approval",
        ...
        "list_calendars", "list_events", "list_mail_drafts", "list_mail_inbox", "list_mail_rules", "list_mailboxes",
